...
class RefreshFooterView: RefreshBaseView {
    class func footer(_ width: CGFloat)->RefreshFooterView{
        let footer:RefreshFooterView  = RefreshFooterView(frame: CGRect(x: 0, y: 0, width: width,
...
//        self.statusLabel.frame = self.bounds;
    ...
    func  totalDataCountInScrollView()->Int
    {
        ...
        if self.scrollView is UITableView {
            ...
            for i:Int in 0  ..< tableView.numberOfSections{
