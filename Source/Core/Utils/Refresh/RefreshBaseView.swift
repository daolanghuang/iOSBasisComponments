...
//    var arrowImage:UIImageView!
    var activityView:PullAnimationView!
...
//        self.addSubview(statusLabel)
        //箭头图片
//        arrowImage = UIImageView(image: UIImage())
...
//        self.autoresizingMask = UIViewAutoresizing.flexibleWidth
        ...
        activityView = PullAnimationView()
        activityView.frame = CGRect(x: frame.width/2 - 23, y: 5, width: 60, height: 50)
...
//        self.activityView.center = self.arrowImage.center
        ...
        activityView.frame = CGRect(x: self.frame.width/2 - 23, y: 5, width: 60, height: 50)
    }
